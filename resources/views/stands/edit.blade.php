            ...
            <div class="card border-0 shadow-lg">
                <div class="card-header bg-white border-0 py-4">
                    <div class="d-flex align-items-center">
                        ...
                        <h3 class="fw-bold mb-0">Modifier "{{ $stand->nom_stand }}"</h3>
                    </div>
                </div>
                    ...
                    <form action="{{ route('stands.update', $stand) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control form-control-lg"
                                   ...
                                   value="{{ old('nom_stand', $stand->nom_stand) }}"
                                   placeholder="Nom de votre stand" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" id="description"
                                      ...
                                      placeholder="Décrivez votre stand en quelques mots...">{{ old('description', $stand->description) }}</textarea>
